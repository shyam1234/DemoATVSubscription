...
class ResultsMatchesListAdapter(private val callBack: ResultsMatchesItemClickListener,
                                private val callBackWatchLiveItemClickListener: ResultsWatchLiveItemClickListener,
private val keyListener: KeyListener?): RecyclerView.Adapter<ResultsMatchesListAdapter.MainViewHolder>(), View.OnKeyListener{

    private var matchList = mutableListOf<ResultsByDate>()
    private var listAllMatches : Boolean ?= false
    private var selectedPosition = -1
    private lateinit var mRecyclerView: RecyclerView

    fun setMatchesListToRV(matches: ResultsWrapperDataModel) {
    ...
    override fun onBindViewHolder(holder: MainViewHolder, position: Int) {
        ...
        Timber.d("ScoreToDisplay:: "+match.getScoreOne()+"::"+match.getScoreTwo())
        Timber.d("DisplayLive:: "+match.display_live_link)
        ...
        holder.binding.layoutMatchInfo.apply {
            ...
            txtMatchScore2.text = match.getScoreTwo()
            txtMatchResult.text = match.match_result
            ...
            if(match.display_live_link){
                ...
                txtHighlightedDateTime.text = match.pst_start_date.substringAfter("@")
            }*/
        }
        ...
        holder.binding.layoutMatchInfo.buttonMatchCenter.setOnClickListener {
            ...
            callBack.onResultsMatchesItemClickListener(match,position)
        }

        holder.binding.layoutMatchInfo.buttonWatchLive.setOnClickListener {

            callBackWatchLiveItemClickListener.onResultsWatchLiveItemClickListener(match)
        }
...
interface ResultsMatchesItemClickListener {
    fun onResultsMatchesItemClickListener(match: ResultsByDate, position: Int)
    fun onFocusPositionChangeListener(position: Int)
}

interface ResultsWatchLiveItemClickListener {
    fun onResultsWatchLiveItemClickListener(match: ResultsByDate)
}