package tv.willow.Views.Pages.VideosPage
...
class MatchCenterVideosAdapter (val context: Context, val videosSectionModel: VideosSectionModel, val matchCenterPageFragment: MatchCenterPageFragment): RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    val BIG_CARD_VIEW = 1
    ...
    inner class CardVideoSmallViewHolder(val binding: CardVideoSmallBinding): RecyclerView.ViewHolder(binding.root) {
        fun setData(data: VideoModel, videosList: List<VideoModel>, matchCenterPageFragment: MatchCenterPageFragment) {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder is CardVideoBigViewHolder) {
            holder.setData(videoData, videosSectionModel.videos, matchCenterPageFragment)
        }
