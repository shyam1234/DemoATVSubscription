package com.willow.android.tv.data.repositories.resultspage.datamodel
...
data class APIResultsDataModel(
    val result: Result
)

data class Result(
    val results_by_date: List<ResultsByDate>,
    val results_by_series: List<ResultsBySery>,
    val status: String
)
@Parcelize
data class ResultsByDate(
...
//        return pst_start_date
    ...
    fun getScoreOne(): String{
        ...
        val scoreList = java.util.ArrayList<String>()
        score?.forEach {
...
//        return  display_live_link == true || display_live_link == true || is_match_live == "1"
//    }
...
data class ResultsBySery(
    ...
    fun getThumbnail(): String {
        return GlobalTVConfig.getImageBaseUrl()+img_path+thumbnails.ptr_mdb
    }
